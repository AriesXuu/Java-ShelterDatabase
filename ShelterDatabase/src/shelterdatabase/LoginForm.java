...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/shelterdatabase/Images/login_header.jpg"))); // NOI18N
...
//private void formWindowOpened(java.awt.event.WindowEvent evt){conn=Connection.();}
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                shelterdatabase.Menu M=new shelterdatabase.Menu();
                M.setVisible(true);
            }
            else{
